                ...
                <div className="flex mb-4">
                    ...
                    <div className='flex flex-col justify-center'>
                        <input
                            ...
                            disabled={!onEdit}
                        />
                        <p className="text-white text-xs mb-4 border bg-red-300 border-red-700 rounded-md w-fit py-[2px] px-1 font-bold">{userInfor.role === 'ROLE_USER' ? 'Người dùng' : 'Nhân viên hệ thống'}</p>
                    </div>
                </div>
                <div className="">
                    <div className='flex'>
                        ...
                        <input
                            type="text"
                            name='phone'
                            className='text-gray-600 text-sm mb-4 ml-1 font-bold border-b border-black outline-none w-[300px]'
                            onChange={e => inputOnChange(e)}
                            readOnly={!onEdit}
