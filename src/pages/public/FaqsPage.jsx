    ...
    const getFAQList = async () => {
        ...
        try {
            ...
            if (response.success) {
                ...
                dispatch(errorMessage(response?.message ? response.message : 'Cõ lỗi xảy ra'))
        ...
        <div className="bg-white h-[80vh] w-[60%] mx-auto p-8">
            ...
            </div>
            {
                faqList.map((faq) => {
                    return (
                        <div className="mt-2">
                            <div className="text-gray-600 font-bold text-lg w-full hover:bg-green-500 hover:text-white cursor-pointer flex items-center duration-300 p-1"
